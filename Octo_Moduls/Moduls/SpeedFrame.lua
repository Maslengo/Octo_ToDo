...
function Octo_EventFrame_SpeedFrame:CreateSpeedFrame()
	...
	Octo_MainFrame_SpeedFrame:SetDontSavePosition(Octo_ToDo_DB_Vars.DontSavePosition)
	Octo_MainFrame_SpeedFrame:SetClampedToScreen(Octo_ToDo_DB_Vars.ClampedToScreen)
