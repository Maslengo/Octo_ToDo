...
function Octo_EventFrame_HideFrames:MustBeHiddenFrames_HOOK()
...
----------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------
function Octo_EventFrame_HideFrames:Hide_OrderHallCommandBar()
...
------------------------------------------------------------------
function Octo_EventFrame_HideFrames:Hide_BossBanner()
...
-------------------------------------------------------------------
function Octo_EventFrame_HideFrames:Hide_Error_Messages()
...
-------------------------------------------------------------------------
function Octo_EventFrame_HideFrames:Hide_RaidWarningFrame()
...
-----------------------------------------------------------------
function Octo_EventFrame_HideFrames:Hide_PTRIssueReporterAlertFrame()
...
---------------------------------------------------------------
function Octo_EventFrame_HideFrames:Hide_Talking_Head_Frame()
...
---------------------------------------------------------------
function Octo_EventFrame_HideFrames:Hide_Zone_Text()
