...
function E.Collect_All_GreatVault()
	if E.Collect_All_GreatVault_pause or InCombatLockdown() then return end
	E.Collect_All_GreatVault_pause = true
	C_Timer.After(E.SPAM_TIME, function()
			...
			E.Collect_All_GreatVault_pause = nil
	end)
end