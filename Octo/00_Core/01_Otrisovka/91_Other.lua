...
function E.func_textCENT(CharInfo)
	...
	if E.DebugInfo then
		...
		tooltipRIGHT[#tooltipRIGHT+1] = {"hasMail", CharInfo.PlayerData.hasMail and E.func_texturefromIcon(E.Icon_MailBox)..CharInfo.PlayerData.classColorHex.."true|r" or E.NIL}
		-- Chromie time debug info
		tooltipRIGHT[#tooltipRIGHT+1] = {"Chromie_canEnter", CharInfo.PlayerData.Chromie_canEnter and E.TRUE or E.NIL}
		tooltipRIGHT[#tooltipRIGHT+1] = {"Chromie_UnitChromieTimeID", CharInfo.PlayerData.Chromie_UnitChromieTimeID or E.NIL.."|r"}
		...
		tooltipRIGHT[#tooltipRIGHT+1] = {"GameLimitedMode_IsActive", CharInfo.PlayerData.GameLimitedMode_IsActive and E.TRUE or E.NIL}
		tooltipRIGHT[#tooltipRIGHT+1] = {"levelCapped20", CharInfo.PlayerData.levelCapped20 and E.TRUE or E.NIL}
		tooltipRIGHT[#tooltipRIGHT+1] = {"PlayerCanEarnExperience", CharInfo.PlayerData.PlayerCanEarnExperience and E.TRUE or E.NIL}
		tooltipRIGHT[#tooltipRIGHT+1] = {" ", " "}
		-- Build info
		...
		tooltipRIGHT[#tooltipRIGHT+1] = {"IsPublicBuild", CharInfo.PlayerData.IsPublicBuild and E.TRUE or E.NIL}
		tooltipRIGHT[#tooltipRIGHT+1] = {" ", " "}
		-- Account limits
		tooltipRIGHT[#tooltipRIGHT+1] = {"max LVL", CharInfo.PlayerData.GetRestrictedAccountData_rLevel and E.TRUE or E.NIL.."|r"}
		tooltipRIGHT[#tooltipRIGHT+1] = {"max Money", CharInfo.PlayerData.GetRestrictedAccountData_rMoney and E.TRUE or E.NIL.."|r"}
		tooltipRIGHT[#tooltipRIGHT+1] = {" ", " "}
		-- Account security
		tooltipRIGHT[#tooltipRIGHT+1] = {"Authenticator", CharInfo.PlayerData.IsAccountSecured and E.TRUE or E.NIL.."|r"}
		tooltipRIGHT[#tooltipRIGHT+1] = {"УЗ имеет ограничения пробной УЗ", CharInfo.PlayerData.IsRestrictedAccount and E.TRUE or E.NIL.."|r"}
		tooltipRIGHT[#tooltipRIGHT+1] = {"Использует ли игрок пробную УЗ", CharInfo.PlayerData.IsTrialAccount and E.TRUE or E.NIL.."|r"}
		tooltipRIGHT[#tooltipRIGHT+1] = {"Нет игрового времени", CharInfo.PlayerData.IsVeteranTrialAccount and E.TRUE or E.NIL.."|r"}
		tooltipRIGHT[#tooltipRIGHT+1] = {" ", " "}
		-- Durability
