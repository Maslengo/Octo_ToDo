...
function E:func_Otrisovka_04_Cataclysm()
	...
	if Octo_ToDo_DB_Vars.ExpansionToShow[OCTOexpansionID] then
		table.insert(OctoTable_Otrisovka, function(CharInfo)
				...
				tooltipLEFT = E.func_tooltipCurrencyAllPlayers("Item", 52078)
				----------------------------------------------------------------
		...
		table.insert(OctoTable_Otrisovka, function(CharInfo)
				...
				tooltipLEFT = E.func_tooltipCurrencyAllPlayers("Item", 69237)
				----------------------------------------------------------------
		...
		table.insert(OctoTable_Otrisovka, function(CharInfo)
				...
				tooltipLEFT = E.func_tooltipCurrencyAllPlayers("Item", 71998)
				----------------------------------------------------------------
