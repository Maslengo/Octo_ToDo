...
function E:func_Otrisovka_06_WarlordsofDraenor()
	...
	if Octo_ToDo_DB_Vars.ExpansionToShow[OCTOexpansionID] then
		table.insert(OctoTable_Otrisovka, function(CharInfo)
				...
				tooltipLEFT = E.func_tooltipCurrencyAllPlayers("Currency", 1129)
				----------------------------------------------------------------
		...
		table.insert(OctoTable_Otrisovka, function(CharInfo)
				...
				tooltipLEFT = E.func_tooltipCurrencyAllPlayers("Currency", 994)
				----------------------------------------------------------------
		...
		table.insert(OctoTable_Otrisovka, function(CharInfo)
				...
				tooltipLEFT = E.func_tooltipCurrencyAllPlayers("Currency", 823)
				----------------------------------------------------------------
		...
		table.insert(OctoTable_Otrisovka, function(CharInfo)
				...
				tooltipLEFT = E.func_tooltipCurrencyAllPlayers("Currency", 1101)
				----------------------------------------------------------------
		...
		table.insert(OctoTable_Otrisovka, function(CharInfo)
				...
				tooltipLEFT = E.func_tooltipCurrencyAllPlayers("Currency", 824)
				----------------------------------------------------------------
		...
		table.insert(OctoTable_Otrisovka, function(CharInfo)
				...
				tooltipLEFT = E.func_tooltipCurrencyAllPlayers("Item", 122457)
				----------------------------------------------------------------
