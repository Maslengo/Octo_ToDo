...
function E:func_Otrisovka_02_TheBurningCrusade()
	...
	if Octo_ToDo_DB_Vars.ExpansionToShow[OCTOexpansionID] then
		table.insert(OctoTable_Otrisovka, function(CharInfo)
				...
				tooltipLEFT = E.func_tooltipCurrencyAllPlayers("Item", 23572)
				----------------------------------------------------------------
		...
		table.insert(OctoTable_Otrisovka, function(CharInfo)
				...
				tooltipLEFT = E.func_tooltipCurrencyAllPlayers("Item", 30183)
				----------------------------------------------------------------
		...
		table.insert(OctoTable_Otrisovka, function(CharInfo)
				...
				tooltipLEFT = E.func_tooltipCurrencyAllPlayers("Item", 32428)
				----------------------------------------------------------------
		...
		table.insert(OctoTable_Otrisovka, function(CharInfo)
				...
				tooltipLEFT = E.func_tooltipCurrencyAllPlayers("Item", 34664)
				----------------------------------------------------------------
		...
		table.insert(OctoTable_Otrisovka, function(CharInfo)
				...
				tooltipLEFT = E.func_tooltipCurrencyAllPlayers("Item", 24581)
				-- tooltipLEFT[#tooltipLEFT+1] = {" ", " "}
				if CharInfo.MASLENGO.ItemsInBag[24579] then
					textCENT = CharInfo.MASLENGO.ItemsInBag[24579]
				end
				tooltipLEFT = E.func_tooltipCurrencyAllPlayers("Item", 24579)
				----------------------------------------------------------------
