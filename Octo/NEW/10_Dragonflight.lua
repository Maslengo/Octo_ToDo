...
----------------------------------------------------------------
E.OctoTables_DataOtrisovka.Dragonflight = {}
E.OctoTables_DataOtrisovka.Dragonflight.Text = {E.OctoTable_Expansions[10].color..E.OctoTable_Expansions[10].name.."|r"}
----------------------------------------------------------------
E.OctoTables_DataOtrisovka.Dragonflight.Currencies = {
	2122,
	2118,
	2003,
	1191,
...
----------------------------------------------------------------
E.OctoTables_DataOtrisovka.Dragonflight.Items = {

			209856, 207002, 210254, 213089, 211516, 211515,
}
----------------------------------------------------------------
E.OctoTables_DataOtrisovka.Dragonflight.Reputations = {
...
----------------------------------------------------------------
E.OctoTables_DataOtrisovka.Dragonflight.UniversalQuests = {
		{
			sorted = false,
			showTooltip = true,
...
----------------------------------------------------------------
E.func_TableConcat(E.ALL_Currencies, E.OctoTables_DataOtrisovka.Dragonflight.Currencies)
E.func_TableConcat(E.ALL_Items, E.OctoTables_DataOtrisovka.Dragonflight.Items)
E.func_TableConcat(E.ALL_Reputations, E.OctoTables_DataOtrisovka.Dragonflight.Reputations)
E.func_TableConcat(E.ALL_UniversalQuests, E.OctoTables_DataOtrisovka.Dragonflight.UniversalQuests)

E.func_TableConcat(E.OctoTables_Vibor, E.OctoTables_DataOtrisovka.Dragonflight.Text)