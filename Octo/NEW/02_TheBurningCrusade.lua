...
----------------------------------------------------------------
E.OctoTables_DataOtrisovka.TheBurningCrusade = {}
E.OctoTables_DataOtrisovka.TheBurningCrusade.Text = {E.OctoTable_Expansions[2].color..E.OctoTable_Expansions[2].name.."|r"}
----------------------------------------------------------------
E.OctoTables_DataOtrisovka.TheBurningCrusade.Currencies = {

}
----------------------------------------------------------------
E.OctoTables_DataOtrisovka.TheBurningCrusade.Items = {
...
----------------------------------------------------------------
E.OctoTables_DataOtrisovka.TheBurningCrusade.Reputations = {
...
----------------------------------------------------------------
E.OctoTables_DataOtrisovka.TheBurningCrusade.UniversalQuests = {

}
----------------------------------------------------------------
E.func_TableConcat(E.ALL_Currencies, E.OctoTables_DataOtrisovka.TheBurningCrusade.Currencies)
E.func_TableConcat(E.ALL_Items, E.OctoTables_DataOtrisovka.TheBurningCrusade.Items)
E.func_TableConcat(E.ALL_Reputations, E.OctoTables_DataOtrisovka.TheBurningCrusade.Reputations)
E.func_TableConcat(E.ALL_UniversalQuests, E.OctoTables_DataOtrisovka.TheBurningCrusade.UniversalQuests)

E.func_TableConcat(E.OctoTables_Vibor, E.OctoTables_DataOtrisovka.TheBurningCrusade.Text)