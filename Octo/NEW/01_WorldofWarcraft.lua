...
----------------------------------------------------------------
E.OctoTables_DataOtrisovka.WorldofWarcraft = {}
E.OctoTables_DataOtrisovka.WorldofWarcraft.Text = {E.func_ExpansionVivod(1)}
----------------------------------------------------------------
E.OctoTables_DataOtrisovka.WorldofWarcraft.Currencies = {

}
----------------------------------------------------------------
E.OctoTables_DataOtrisovka.WorldofWarcraft.Items = {

}
----------------------------------------------------------------
E.OctoTables_DataOtrisovka.WorldofWarcraft.Reputations = {
...
----------------------------------------------------------------
E.OctoTables_DataOtrisovka.WorldofWarcraft.UniversalQuests = {

}
----------------------------------------------------------------
E.func_TableConcat(E.ALL_Currencies, E.OctoTables_DataOtrisovka.WorldofWarcraft.Currencies)
E.func_TableConcat(E.ALL_Items, E.OctoTables_DataOtrisovka.WorldofWarcraft.Items)
E.func_TableConcat(E.ALL_Reputations, E.OctoTables_DataOtrisovka.WorldofWarcraft.Reputations)
E.func_TableConcat(E.ALL_UniversalQuests, E.OctoTables_DataOtrisovka.WorldofWarcraft.UniversalQuests)

E.func_TableConcat(E.OctoTables_Vibor, E.OctoTables_DataOtrisovka.WorldofWarcraft.Text)