...
function EventFrame:func_CreateMainFrame()
	...
	Octo_MainFrame.ScrollBoxCenter = CreateFrame("FRAME", nil, scrollContentFrame, "WowScrollBoxList,OctoRectTemplate")
	...
	Octo_MainFrame.ViewCenter:SetElementInitializer("OctoRectTemplate", function(...) self:func_InitCenter(...) end)
