...
function EventFrame:Create_OctoDebugFunctions()
...
function EventFrame:func_OctoDebugFunctions_CreateDataProvider()
	local lines = 0
...
local function Toggle_OctoDebugFunctions()
	if not OctoDebugFunctions:IsShown() then
		EventFrame:func_OctoDebugFunctions_CreateDataProvider()
	end
	OctoDebugFunctions:SetShown(not OctoDebugFunctions:IsShown())
end
function EventFrame:CreateTestButton3()
	...
	EventFrame:func_SmartAnchorTo(TestButton3)
end
local MyEventsTable = {
	"VARIABLES_LOADED",
	"BAG_UPDATE_DELAYED",
