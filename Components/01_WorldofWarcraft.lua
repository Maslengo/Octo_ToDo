...
local function tempFunction()
	...
	OctoTables_DataOtrisovka[categoryKey].Reputations = {
		...
		{id = 2523, defS = false,}, --name = "Темные Когти", side = "Horde", category = "Орда", }, --[faction=2523]
		{id = 1352, defS = false,}, --name = "Пандарены Хоцзинь", side = "Horde", category = "Орда", }, --[faction=1352]
		{id = 1133, defS = false,}, --name = "Картель Трюмных Вод", side = "Horde", category = "Орда", }, --[faction=1133]
		{id = 911, defS = false,}, --name = "Луносвет", side = "Horde", category = "Орда", }, --[faction=911]
		{id = 530, defS = false,}, --name = "Племя Черного Копья", side = "Horde", category = "Орда", }, --[faction=530]
		{id = 81, defS = false,}, --name = "Громовой Утес", side = "Horde", category = "Орда", }, --[faction=81]
		{id = 76, defS = false,}, --name = "Оргриммар", side = "Horde", category = "Орда", }, --[faction=76]
		{id = 68, defS = false,}, --name = "Подгород", side = "Horde", category = "Орда", }, --[faction=68]
		----------------------------------------------------------------
		...
		{id = 2524, defS = false,}, --name = "Обсидиановые Хранители", side = "Alliance", category = "Альянс", }, --[faction=2524]
		{id = 1353, defS = false,}, --name = "Пандарены Тушуй", side = "Alliance", category = "Альянс", }, --[faction=1353]
		{id = 1134, defS = false,}, --name = "Гилнеас", side = "Alliance", category = "Альянс", }, --[faction=1134]
		{id = 930, defS = false,}, --name = "Экзодар", side = "Alliance", category = "Альянс", }, --[faction=930]
		{id = 72, defS = false,}, --name = "Штормград", side = "Alliance", category = "Альянс", }, --[faction=72]
		{id = 69, defS = false,}, --name = "Дарнас", side = "Alliance", category = "Альянс", }, --[faction=69]
		{id = 54, defS = false,}, --name = "Гномреган", side = "Alliance", category = "Альянс", }, --[faction=54]
		{id = 47, defS = false,}, --name = "Стальгорн", side = "Alliance", category = "Альянс", }, --[faction=47]
		----------------------------------------------------------------
