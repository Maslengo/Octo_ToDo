...
MAIN_Config:SetScript("OnShow", function(self)
		...
		if Octo_ToDo_DB_Vars.config.security ~= "" then
			...
			Create_CheckButton(MAIN_scrollChild, self, 5, POS_CENTER+(indent), "ResearchersUnderFire_Weekly", E.Octo_Globals.Weekly..L["A Worthy Ally: Loamm Niffen"])
			...
			Create_CheckButton(MAIN_scrollChild, self, 7, POS_CENTER, "EmeraldDream_Superbloom", E.Octo_Globals.Weekly..L["Superbloom"])
			Create_CheckButton(MAIN_scrollChild, self, 8, POS_CENTER+(indent), "EmeraldDream_Superbloom_Weekly", E.Octo_Globals.Weekly..L["Blooming Dreamseeds"])
			...
			Create_CheckButton(MAIN_scrollChild, self, 19, POS_RIGHT, "PortalsButtons", E.Octo_Func.func_texturefromIcon(3610528, 20)..L["Portals"].." "..L["InDev"], E.Octo_Globals.Green_Color)
			Create_CheckButton(MAIN_scrollChild, self, 20, POS_RIGHT, "ItemsUsable", "ItemsUsable".." "..L["InDev"])
			Create_CheckButton(MAIN_scrollChild, self, 21, POS_RIGHT, "ItemsDelete", "ItemsDelete".." "..L["InDev"])
...
FIRST_Config:SetScript("OnShow", function(self)
		...
		if Octo_ToDo_DB_Vars.config.security ~= "" then
			...
			Create_CheckButton(FIRST_scrollChild, self, 18, POS_CENTER, "ChallengesKeystoneFrame", "ChallengesKeystoneFrame")
