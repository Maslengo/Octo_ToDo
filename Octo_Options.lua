...
MAIN_Config:SetScript("OnShow", function(self)
		...
		if Octo_ToDo_DB_Vars.config.security ~= "" then
			...
			Create_CheckButton(MAIN_scrollChild, self, 6, POS_CENTER, "EmeraldDream_Superbloom", E.Octo_Globals.Weekly..L["Superbloom"])
			Create_CheckButton(MAIN_scrollChild, self, 7, POS_CENTER, "EmeraldDream_WB", E.Octo_Globals.Weekly..L["World Boss"])
			Create_CheckButton(MAIN_scrollChild, self, 8, POS_CENTER, "EmeraldDream_DreamWardens", L["Dream Wardens"]..E.Octo_Globals.Gray_Color.." ("..REPUTATION..")|r")
			Create_CheckButton(MAIN_scrollChild, self, 9, POS_CENTER, "EmeraldDream_Dreamseeds", E.Octo_Globals.Weekly..L["Dreamseeds"])
			Create_CheckButton(MAIN_scrollChild, self, 10, POS_CENTER, "EmeraldDream_Rares", E.Octo_Globals.Daily..L["Rares"]..", "..L["Treasures"]..E.Octo_Globals.Gray_Color.." ("..QUESTS_LABEL..")|r")
			Create_CheckButton(MAIN_scrollChild, self, 11, POS_CENTER, "EmeraldDream_Storyline", E.Octo_Globals.Once..L["Storyline"]..E.Octo_Globals.Gray_Color.." ("..QUESTS_LABEL..")|r")
			Create_CheckButton(MAIN_scrollChild, self, 12, POS_CENTER, "CatalystCharges", L["Catalyst Charges"]..E.Octo_Globals.Gray_Color.." ("..CURRENCY..")|r")
			Create_CheckButton(MAIN_scrollChild, self, 13, POS_CENTER, "Flightstones", L["Flightstones"]..E.Octo_Globals.Gray_Color.." ("..CURRENCY..")|r")
			Create_CheckButton(MAIN_scrollChild, self, 14, POS_CENTER, "EmeraldDream_Crests", L["Crests"]..E.Octo_Globals.Gray_Color.." ("..CURRENCY..")|r")
			Create_CheckButton(MAIN_scrollChild, self, 15, POS_CENTER, "EmeraldDream_Sparks", L["Sparks"].." + "..L["Crests"]..E.Octo_Globals.Gray_Color.." ("..ITEMS..")|r")
			...
			Create_CheckButton(MAIN_scrollChild, self, 21, POS_CENTER, "Dungeons", E.Octo_Globals.LightGray_Color.."КД инстов".."|r")
			Create_CheckButton(MAIN_scrollChild, self, 22, POS_CENTER, "Currency", E.Octo_Globals.LightGray_Color..CURRENCY.."|r")
			Create_CheckButton(MAIN_scrollChild, self, 23, POS_CENTER, "Reputations", E.Octo_Globals.LightGray_Color..REPUTATION.."|r")
			Create_CheckButton(MAIN_scrollChild, self, 24, POS_CENTER, "Quests", E.Octo_Globals.LightGray_Color..QUESTS_LABEL.."|r")
			Create_CheckButton(MAIN_scrollChild, self, 25, POS_CENTER, "Items", E.Octo_Globals.LightGray_Color..ITEMS.."|r")
...
FIRST_Config:SetScript("OnShow", function(self)
		...
		if Octo_ToDo_DB_Vars.config.security ~= "" then
			...
			Create_CheckButton(FIRST_scrollChild, self, 3, POS_CENTER, "AnotherAddonsDUNG", "AnotherAddonsDUNG")
			Create_CheckButton(FIRST_scrollChild, self, 4, POS_CENTER, "AnotherAddonsRAID", "AnotherAddonsRAID")
			Create_CheckButton(FIRST_scrollChild, self, 5, POS_CENTER, "CVar", "CVar")
			Create_CheckButton(FIRST_scrollChild, self, 6, POS_CENTER, "SORTING", "SORTING")
			Create_CheckButton(FIRST_scrollChild, self, 7, POS_CENTER, "SellFrame", "SellFrame")
			Create_CheckButton(FIRST_scrollChild, self, 8, POS_CENTER, "GlobalFadePersist", "GlobalFadePersist")
			Create_CheckButton(FIRST_scrollChild, self, 9, POS_CENTER, "LootFrame", "LootFrame")
			Create_CheckButton(FIRST_scrollChild, self, 10, POS_CENTER, "PortalsNEW", E.Octo_Func.func_texturefromIcon(3610528, 20)..L["Portals"], E.Octo_Globals.Green_Color)
			Create_CheckButton(FIRST_scrollChild, self, 11, POS_CENTER, "THIRD", E.Octo_Func.func_texturefromIcon("Interface/Addons/"..GlobalAddonName.."/Media/AddonTexture_THIRD.tga", 20).."THIRD")
			Create_CheckButton(FIRST_scrollChild, self, 12, POS_CENTER, "TalentTreeTweaks", "TalentTreeTweaks")
			Create_CheckButton(FIRST_scrollChild, self, 13, POS_CENTER, "Octo_debug_Function_FIRST", E.Octo_Func.func_texturefromIcon("Interface/AddOns/"..GlobalAddonName.."/Media/AddonTexture_FIRST.tga", 22).."Function 1", E.Octo_Globals.Blue_Color)
			Create_CheckButton(FIRST_scrollChild, self, 14, POS_CENTER, "Octo_debug_Event_FIRST", E.Octo_Func.func_texturefromIcon("Interface/AddOns/"..GlobalAddonName.."/Media/AddonTexture_FIRST.tga", 22).."Event 1", E.Octo_Globals.Green_Color)
			Create_CheckButton(FIRST_scrollChild, self, 15, POS_CENTER, "Octo_debug_BUTTONS_FIRST", E.Octo_Func.func_texturefromIcon("Interface/AddOns/"..GlobalAddonName.."/Media/AddonTexture_FIRST.tga", 22).."BUTTONS 1", E.Octo_Globals.Addon_Left_Color)
			Create_CheckButton(FIRST_scrollChild, self, 16, POS_CENTER, "Octo_debug_Function_SECOND", E.Octo_Func.func_texturefromIcon("Interface/AddOns/"..GlobalAddonName.."/Media/AddonTexture_SECOND.tga", 22).."Function 2", E.Octo_Globals.Blue_Color)
			Create_CheckButton(FIRST_scrollChild, self, 17, POS_CENTER, "Octo_debug_Event_SECOND", E.Octo_Func.func_texturefromIcon("Interface/AddOns/"..GlobalAddonName.."/Media/AddonTexture_SECOND.tga", 22).."Event 2", E.Octo_Globals.Green_Color)
			Create_CheckButton(FIRST_scrollChild, self, 18, POS_CENTER, "Octo_debug_BUTTONS_SECOND", E.Octo_Func.func_texturefromIcon("Interface/AddOns/"..GlobalAddonName.."/Media/AddonTexture_SECOND.tga", 22).."BUTTONS 2", E.Octo_Globals.Addon_Left_Color)
			Create_CheckButton(FIRST_scrollChild, self, 19, POS_CENTER, "ChallengesKeystoneFrame", "ChallengesKeystoneFrame")
			Create_CheckButton(FIRST_scrollChild, self, 20, POS_CENTER, "ItemsUsable", "ItemsUsable")
			Create_CheckButton(FIRST_scrollChild, self, 21, POS_CENTER, "ItemsDelete", "ItemsDelete")
