...
MAIN_Config:SetScript("OnShow", function(self)
		...
		Create_CheckButton(MAIN_scrollChild, self, 10, POS_CENTER, "EmeraldDream_DreamWardens", E.Octo_Globals.Weekly..L["Dream Wardens"]..E.Octo_Globals.Gray_Color.." ("..REPUTATION..")|r")
		...
		Create_CheckButton(MAIN_scrollChild, self, 23, POS_CENTER, "Dungeons", E.Octo_Globals.LightGray_Color..DUNGEONS.."|r")
		...
		Create_EditBox(MAIN_scrollChild, self, 33, POS_RIGHT, "security")
		Create_SimpleButton(MAIN_scrollChild, self, 34, POS_RIGHT, "ReloadUI", "ReloadUI")
end)
