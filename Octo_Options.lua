...
MAIN_Config:SetScript("OnShow", function(self)
		...
		Create_CheckButton(MAIN_scrollChild, self, 17, POS_LEFT, "Hide_ObjectivesInInstance", "Hide_ObjectivesInInstance")
		Create_CheckButton(MAIN_scrollChild, self, 18, POS_LEFT, "ChallengesKeystoneFrame", "ChallengesKeystoneFrame")
