...
MAIN_Config:SetScript("OnShow", function(self)
		...
		Create_CheckButton(MAIN_scrollChild, self, 24, POS_RIGHT, 0, "Octo_debug_Event_FIRST", E.Octo_Func.func_texturefromIcon("Interface/AddOns/"..GlobalAddonName.."/Media/AddonTexture_FIRST.tga", 22).."Event 1", .31, 1, .47, E.Octo_Globals.BGALPHA)
