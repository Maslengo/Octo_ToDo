...
MAIN_Config:SetScript("OnShow", function(self)
		...
		Create_CheckButton(MAIN_scrollChild, self, 19, POS_LEFT, "Hide_ObjectivesInInstance", "Hide_ObjectivesInInstance")
		Create_CheckButton(MAIN_scrollChild, self, 20, POS_LEFT, "ChallengesKeystoneFrame", "ChallengesKeystoneFrame")
		...
		Create_CheckButton(MAIN_scrollChild, self, 16, POS_RIGHT, "ShowTime", "Общее время игры")
