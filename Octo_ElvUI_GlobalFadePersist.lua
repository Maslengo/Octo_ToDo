...
local isElfUI = IsAddOnLoaded("ElvUI")
	...
	local GFP = E:NewModule('Octo_ElvUI_GlobalFadePersist', 'AceHook-3.0', 'AceEvent-3.0'); --Create a plugin within ElvUI and adopt AceHook-3.0, AceEvent-3.0 and AceTimer-3.0. We can make use of these later.
