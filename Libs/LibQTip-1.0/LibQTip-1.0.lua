...
function layoutCleaner:CleanupLayouts()
 self:Hide()
 for tooltip in next, (self.registry) do
...
function ClearTooltipScripts(tooltip)
 ...
 for scriptType in next, (tooltip.scripts) do
...
function tipPrototype:Clear()
 ...
 for _, cell in next, (line.cells) do
 if cell then
 ReleaseCell(cell)
 end
 end
...
function FixCellSizes(tooltip)
 ...
 for colRange, width in next, (colspans) do
...
local function PrintStats()
 ...
 for k in next, (activeTooltips) do
 if not header then
