...
lib.getNames = function(pattern)
	local names,_ = {}
	for name,_ in next, (lib.colorset) do
...
do --[[ basic set of colors ]]
	...
	for n, c in next, (classColors) do
	...
	for i,v in next, (_G.ITEM_QUALITY_COLORS) do
		tmp["quality"..i] = v;
