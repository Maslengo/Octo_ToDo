...
function E.func_Tooltip_Chars(CharInfo)
	...
	if Name ~= "" and curServer ~= "" then
		tooltip[#tooltip + 1] = {
			...
			-- PlayerDurability < 100 and E.func_texturefromIcon(4620670)..durColor..PlayerDurability.."%|r" or ""
			-- PlayerDurability < 100 and E.func_texturefromIcon("SpellIcon-256x256-RepairAll", nil, nil, true)..durColor..PlayerDurability.."%|r" or ""
		}
	end
	-- tooltip[#tooltip+1] = {"---"}
	-- ===== Guild =====
	...
	-- if PlayerDurability < 100 then
		-- tooltip[#tooltip+1] = {DURABILITY.." "..durColor..PlayerDurability.."%|r"}
	-- end
