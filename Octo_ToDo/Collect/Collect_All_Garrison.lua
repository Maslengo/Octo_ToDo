...
----------------------------------------------------------------
local function Collect_All_Garrison()
...
local function Collect_All_lastCacheTime(...)
...
function E.Collect_All_Garrison()
	E.func_SpamBlock(Collect_All_Garrison, true)
end

function E.Collect_All_lastCacheTime(...)
	local key = (""):join(tostringall(...))
	E.func_SpamBlock(Collect_All_lastCacheTime(...), true, ...)
end