...
function Octo_ToDo_THIRD_CreateAltFrame()
    ...
    for i = 1, #OctoTable_func_otrisovka_THIRD do
        local fname, f
        fname = "FrameLine"..i
        Octo_ToDo_THIRD_Frame_Main_Frame[fname] = CreateFrame("Frame", AddonTitle..E.Octo_Func.GenerateUniqueID().."FrameLine"..i, Octo_ToDo_THIRD_Frame_Main_Frame.scrollChild, "BackdropTemplate")
        ...
        f.BG:SetAllPoints()
        fname = "TextLeft"..i
        Octo_ToDo_THIRD_Frame_Main_Frame[fname] = Octo_ToDo_THIRD_Frame_Main_Frame.scrollChild:CreateFontString(nil, "ARTWORK", "GameFontNormalSmall")
        f = Octo_ToDo_THIRD_Frame_Main_Frame[fname]
...
local function GetOrCreateLine(Main_Frame, curCharGUID)
    ...
    for index = 1, #OctoTable_func_otrisovka_THIRD do
        local CF = CreateFrame("Button", "CF"..index, Octo_ToDo_THIRD_Frame_Char_Frame)
        ...
        Octo_ToDo_THIRD_Frame_Char_Frame["CenterLines"..index.."BG"] = Octo_ToDo_THIRD_Frame_Char_Frame:CreateTexture(nil, "BACKGROUND")
        Octo_ToDo_THIRD_Frame_Char_Frame["CenterLines"..index.."BG"]:SetAllPoints(Octo_ToDo_THIRD_Frame_Char_Frame["CenterLines"..index])
        Octo_ToDo_THIRD_Frame_Char_Frame["CenterLines"..index.."BG"]:SetColorTexture(r, g, b, 0)
        CF.CL = CL
    end
end
function Octo_ToDo_THIRD_AddDataToAltFrame()
    ...
    for i, CharInfo in pairs(sorted) do
            ...
            if not Octo_ToDo_THIRD_Frame_Main_Frame[curCharGUID] then
                GetOrCreateLine(Octo_ToDo_THIRD_Frame_Main_Frame, curCharGUID)
            else
                Octo_ToDo_THIRD_Frame_Char_Frame = Octo_ToDo_THIRD_Frame_Main_Frame[curCharGUID]
            end
