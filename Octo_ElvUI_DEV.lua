...
local Enable_Module = true
    if isElfUI and Enable_Module == true then
	local E, L, V, P, G = unpack(ElvUI); --Import: Engine, Locales, PrivateDB, ProfileDB, GlobalDB
	local MyPlugin = E:NewModule("Octo_ElvUI_DEV", "AceHook-3.0", "AceEvent-3.0", "AceTimer-3.0");
	local EP = LibStub("LibElvUIPlugin-1.0")
	local addonName, addonTable = ...
	P["Octo_ElvUI_DEV"] = {
		["HideObjectiveTracker"] = false, --дефолт
		["HideZoneText"] = true, --дефолт
		["Covenant"] = true, --дефолт
		["UIErrorsFrame"] = false, --дефолт
		["RaidBossEmoteFrame"] = true, --дефолт
		["CinematicCanceler"] = true, --дефолт
		["TalkingHeadFrame"] = true, --дефолт
		["BossBanner"] = true, --дефолт
		["MajorFactionsRenownToast"] = true, --дефолт
	}
