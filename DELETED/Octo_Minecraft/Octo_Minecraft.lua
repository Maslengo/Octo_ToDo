...
function EventFrame:CreateOcto_MinecraftFrameFG()
	...
	Octo_MinecraftFrameFG:SetDontSavePosition(Octo_ToDo_DB_Vars.Config_DontSavePosition)
	Octo_MinecraftFrameFG:SetClampedToScreen(Octo_ToDo_DB_Vars.Config_ClampedToScreen)
