...
function E:BuildLog()
	...
	QC_Quests:SetDontSavePosition(true)
	QC_Quests:SetClampedToScreen(Octo_ToDo_DB_Vars.Config_ClampedToScreen)
...
function E:BuildQuestLog()
	...
	local initializer = function(line, index)
		if not line.Title then
			...
			line.Coords = line:CreateFontString()
			line.Coords:SetFontObject(OctoFont11)
