...
local g_addonCategoriesCollapsed = { };
...
-- local UIPanelWindows["AddonList"] = { area = "center", pushable = 0, whileDead = 1 };

-- We use this in the shared XML file
local AddonTooltip = nil;
local AddonDialog = nil;

local AddonDialogMixin = { };
...
function AddonTooltip_Update(owner)
	...
	if loaded and C_AddOnProfiler.IsEnabled()  then
