...
function OctoToDo_EventFrame:ADDON_LOADED(addonName)
	if addonName == GlobalAddonName then
		...
		----------------------------------------------------------------
		OctoToDo_Reputations = OctoToDo_Reputations or {}
		----------------------------------------------------------------
		...
		OctoToDo_Reputations.minimap = OctoToDo_Reputations.minimap or {}
		OctoToDo_Reputations.minimap.minimapPos = OctoToDo_Reputations.minimap.minimapPos or 244
		LibDBIcon:Register(MinimapName, ldb_icon, OctoToDo_Reputations.minimap)
