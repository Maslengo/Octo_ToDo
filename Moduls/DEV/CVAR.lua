		...
		if Octo_ToDoVars.config.CVar then
			if not InCombatLockdown() then
				C_Timer.After(1, function()
						...
						SetCVar("lastRenownForMajorFaction2503", 20)
						SetCVar("lastRenownForMajorFaction2507", 20)
						SetCVar("lastRenownForMajorFaction2510", 20)
						SetCVar("lastRenownForMajorFaction2511", 20)
