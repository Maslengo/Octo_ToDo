...
tinsert(E.Octo_Globals.modules, function()
	if Octo_ToDo_DB_Vars.config.AnotherAddonsDUNG then
		...
		E.Octo_Func.func_Octo_LoadAddOn("LittleWigs_BattleForAzeroth")
		E.Octo_Func.func_Octo_LoadAddOn("LittleWigs_BurningCrusade")
		E.Octo_Func.func_Octo_LoadAddOn("LittleWigs_Cataclysm")
		E.Octo_Func.func_Octo_LoadAddOn("LittleWigs_Classic")
		E.Octo_Func.func_Octo_LoadAddOn("LittleWigs_Legion")
		E.Octo_Func.func_Octo_LoadAddOn("LittleWigs_MistsOfPandaria")
		E.Octo_Func.func_Octo_LoadAddOn("LittleWigs_Shadowlands")
		E.Octo_Func.func_Octo_LoadAddOn("LittleWigs_WarlordsOfDraenor")
		E.Octo_Func.func_Octo_LoadAddOn("LittleWigs_WrathOfTheLichKing")
		E.Octo_Func.func_Octo_LoadAddOn("LittleWigs")
		E.Octo_Func.func_Octo_LoadAddOn("MythicDungeonTools")
		E.Octo_Func.func_Octo_LoadAddOn("PremadeGroupsFilter")
		E.Octo_Func.func_Octo_LoadAddOn("RaiderIO")
		E.Octo_Func.func_Octo_LoadAddOn("RaiderIO_DB_EU_F")
		E.Octo_Func.func_Octo_LoadAddOn("RaiderIO_DB_EU_M")
		E.Octo_Func.func_Octo_LoadAddOn("RaiderIO_DB_EU_R")
		...
		E.Octo_Func.func_Octo_LoadAddOn("WarpDeplete")
	end
end)
